...
contract Poll is IPoll {
	...
	string public override constant purpose = "Vote on your favorite breed of dog";
	...
	constructor() {
		addChoice("australian shephard");
		addChoice("corgi");
		addChoice("golden retriever");
		addChoice("poodle");
		addChoice("black lab");
		addChoice("cats are better");
	}
